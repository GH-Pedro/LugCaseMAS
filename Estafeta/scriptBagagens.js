...
function ViewModel({localRecolha, localEntrega, diaRecolha, horaRecolha, prioridade, coordsRecolha, coordsEntrega, bagagens}) {
  ...
  self.andamento = ko.observable("<p><i class='fa fa-clock-o' aria-hidden='true'></i> Em Preperação</p>")
  self.toRec = function() {
    self.andamento("<p><i class='fa fa-clock-o' aria-hidden='true'></i> Em Preparação</p>")
  }
  self.toTran = function() {
    self.andamento("<p><i class='fa fa-truck' aria-hidden='true'></i> Em transporte</p>")
  }
  self.toConc = function() {
    self.andamento("<p><i class='fa fa-check' aria-hidden='true'></i> Concluído</p>")
  }
